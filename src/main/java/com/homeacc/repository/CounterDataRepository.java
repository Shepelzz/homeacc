...
public interface CounterDataRepository extends CrudRepository<CounterData, Integer> {
    ...
    List<CounterData> findByCounterId(@Param("counterId") Integer counterId);
    ...
    List<CounterData> findByPropertyId(@Param("propertyId") Integer propertyId);
    ...
    List<Counter> getAllDataForPeriod(
        ...
        @Param("yearMonthFrom") Integer yearMonthFrom,
        @Param("yearMonthTo") Integer yearMonthTo);
}